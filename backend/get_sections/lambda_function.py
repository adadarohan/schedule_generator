...
def get_rmp_info(first_initial, last_name, subject_code) :
    ...
    if len(possible_profs) == 0:
        ...
        resp = requests.get("https://courses.illinois.edu/cisapp/explorer/schedule/2025/spring.xml", timeout=10)
...
def get_sections (code, number) :
    ...
    selected_class = classes.find_one({'code': code, 'number': number, 'year': 2025, 'semester': 'spring'})
