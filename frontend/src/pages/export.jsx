  ...
  return (
    <div className="font-serif max-h-screen flex flex-col">
      <div className="pl-10 pt-12">
        <h2 className="text-5xl">Step 9</h2>
        <h1 className="font-display text-5xl pt-2">register and save</h1>
      </div>

      <div className="flex flex-col pt-12 pl-10 max-h-[70vh]">
        <p className="text-2xl">Add the following sections to your course explorer</p>
        <hr className="mr-10 mt-3 border-black border-[1.5px] mb-5"></hr>

        <div className="overflow-auto mb-5">
          <div className="w-[70%] grid grid-cols-4 gap-x-1 gap-y-5 pt-1">
            ...
            <div key={index} className="contents text-2xl">
              <p>{section.crn}</p>
              <p >{section.class.code} {section.class.number}</p>
              <p>{section.section_number}</p>
              <p >{section.meetings[0].type}</p>
      ...
      <div className="fixed bottom-0 left-0 pl-10 pb-8 flex flex-row">
        <Link className="rounded-full bg-black border-black border-2 py-2 px-3 mr-6 cursor-pointer" to="https://forms.gle/ZF2ABDbhEJBWPDqr8">
          <p className="text-3xl text-white text-center px-4">leave some feedback!</p>
        </Link>

        <Link  className="rounded-full  border-black border-2 py-2 px-3 cursor-pointer" to="mailto:rohankapur2005@gmail.com">
          <p className="text-3xl text-center px-4">contact us</p>
        </Link>
      </div>
