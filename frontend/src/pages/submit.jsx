...
export default function Submit(props) {
  ...
  useEffect(() => {
    ...
    try {
      fetch(
        import.meta.env.VITE_GET_SCHEDULE_URL +
          "?data=" +
  ...
  return (
    <div className="font-serif">
      <div className="pl-5 sm:pl-10 pt-32">
        ...
        <h1 className="font-display text-5xl sm:text-[84px] pt-2 loading">
          is happening{" "}
        </h1>
      </div>

      <h5 className="text-2xl sm:text-4xl px-5 sm:pl-10 pt-32 sm:pt-20">
